...
public class Connector {
     ...
     * 密码路径
     */
    public static final String PASSWORD_PATH = "D:\\wifi\\all.txt";

    /**
     * 配置文件暂时存放路径
     */
    public static final String PROFILE_TEMP_PATH = "D:\\wifi\\profile";

    /**
     * 破解成功wifi存放路径
     */
    public static final String RESULT_PATH = "D:\\wifi\\record.txt";

    /**
     * 日志存放路径
     */
    public static final String LOG_PATH = "D:\\wifi\\log.txt";
...
//        List<Ssid> ssidList = WlanExecute.listSsid();
        ...
        ssidList.clear();
        for(String ssid: args){
            if(ssid != null && !"".equals(ssid)){
                ssidList.add(ssid);
            }
        }
 //       ssidList.add("R&D Dep");
//        ssidList.add("TP-LINK_5410");
//        ssidList.add("ChinaNet-WWS2");
        new File(Connector.PROFILE_TEMP_PATH).deleteOnExit();
        new File(Connector.PROFILE_TEMP_PATH).mkdirs();
